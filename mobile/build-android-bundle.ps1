...
foreach ($app in $apps) {
  ...
  Write-Host "==> Android App Bundle release: $app" -ForegroundColor Cyan
  Push-Location $dir
  npm.cmd run build
...
Write-Host "AABs gerados em */android/app/build/outputs/bundle/release/." -ForegroundColor Green
