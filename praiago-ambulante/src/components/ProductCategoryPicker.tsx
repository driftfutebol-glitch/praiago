...
type CategoryPhotoProps = {
  category: ProductCategory
  size?: number
}

export function CategoryPhoto({ category, size = 54 }: CategoryPhotoProps) {
...
export default function ProductCategoryPicker({ value, onChange }: ProductCategoryPickerProps) {
    ...
    <div>
      <div className="category-picker-toolbar">
        <div>
          ...
          <div className="field-help">Define onde o produto aparece no app Cliente.</div>
        </div>
        <button
          type="button"
