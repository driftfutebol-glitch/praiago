    ...
    >
      ...
      >
        <header style={{ display: 'flex', alignItems: 'center', gap: 11, padding: '16px 18px', borderBottom: '1px solid #dfe6ed' }}>
          ...
          {/* Sem classe compartilhada: o painel do restaurante nao tem
              `icon-button` no CSS, e o botao sairia sem estilo nenhum. */}
          <button
            type="button"
            onClick={onClose}
            aria-label="Fechar conversa"
            style={{ border: 0, background: '#f1f5f9', borderRadius: 999, width: 34, height: 34, cursor: 'pointer', display: 'grid', placeItems: 'center', color: '#475569', flexShrink: 0 }}
          >
            <X size={18} />
          </button>
        </header>
